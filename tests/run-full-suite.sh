...
echo "7) Story: monitor-driven health-check e2e (browser)"
...
echo "8) Demo: clean install needs no post-install steps"
...
echo "9) Extended: hermes user suite (default profile)"
...
echo "10) Extended: vibecoder suite (default profile)"
...
echo "11) Extended: shadow coverage check (default profile)"
